      ...
      <div ref={ref} className="relative z-10 max-w-4xl mx-auto px-6 py-20 md:py-28 text-center">
        ...
        <motion.div className="flex justify-center mb-10"
          ...
          <svg width="72" height="72" viewBox="0 0 72 72">
            {/* Outer ring */}
            <circle cx="36" cy="36" r="34" fill="none" stroke="rgba(212,175,55,0.2)" strokeWidth="0.8" />
            {/* Crescent */}
            <path d="M36 12 A22 22 0 1 1 36 60 A14 14 0 1 0 36 12Z" fill="rgba(212,175,55,0.18)" stroke="#D4AF37" strokeWidth="1" />
            {/* Star */}
        ...
        <motion.div className="flex items-center justify-center gap-4 mb-14"
          ...
          {contact.instagram && (
            <a href={`https://instagram.com/${contact.instagram}`} target="_blank" rel="noopener noreferrer"
              ...
              style={{ background: 'rgba(212,175,55,0.1)', border: '1px solid rgba(212,175,55,0.25)' }} aria-label="Instagram">
              <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="1.8">
          ...
          {contact.facebook && (
            <a href={`https://facebook.com/${contact.facebook}`} target="_blank" rel="noopener noreferrer"
              className="w-11 h-11 rounded-full flex items-center justify-center transition-all hover:scale-110"
              style={{ background: 'rgba(212,175,55,0.1)', border: '1px solid rgba(212,175,55,0.25)' }} aria-label="Facebook">
              <svg width="17" height="17" viewBox="0 0 24 24" fill="#D4AF37">
        ...
        <motion.div className="pt-8"
          ...
          <div className="flex justify-center mb-5">
            <svg viewBox="0 0 160 16" className="w-32">
              <line x1="0" y1="8" x2="60" y2="8" stroke="rgba(212,175,55,0.3)" strokeWidth="0.8" />
              <circle cx="80" cy="8" r="4" fill="none" stroke="rgba(212,175,55,0.4)" strokeWidth="0.8" />
              <circle cx="80" cy="8" r="1.5" fill="rgba(212,175,55,0.5)" />
              <line x1="100" y1="8" x2="160" y2="8" stroke="rgba(212,175,55,0.3)" strokeWidth="0.8" />
          ...
          <p className={`text-xs ${fontClass}`} style={{ color: 'rgba(255,253,247,0.3)' }}>
