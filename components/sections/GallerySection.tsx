            ...
            return (
              <motion.div key={i} ref={imgRef}
                ...
                <div className="absolute inset-0 flex items-center justify-center"
                  style={{ background: `linear-gradient(${135 + i * 30}deg, rgba(15,81,50,0.8), rgba(10,61,36,0.6))` }}>
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="1" opacity="0.4">
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center"
                  style={{ background: 'rgba(15,81,50,0.5)' }}>
          ...
          <motion.div className="fixed inset-0 z-[150] flex items-center justify-center p-4"
            ...
            <motion.div key={selected} className="relative max-w-3xl max-h-[80vh] w-full"
              ...
              <div className="relative rounded-2xl overflow-hidden"
                style={{ aspectRatio: '4/3', border: '1px solid rgba(212,175,55,0.3)', background: 'linear-gradient(135deg, #0F5132, #0a3d24)' }}>
